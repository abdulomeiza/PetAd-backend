...
-- CreateIndex
CREATE INDEX "pets_current_owner_id_idx" ON "pets"("current_owner_id");
...
-- AddForeignKey
ALTER TABLE "pets" ADD CONSTRAINT "pets_current_owner_id_fkey" FOREIGN KEY ("current_owner_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "custodies" ADD CONSTRAINT "custodies_pet_id_fkey" FOREIGN KEY ("pet_id") REFERENCES "pets"("id") ON DELETE CASCADE ON UPDATE CASCADE;
